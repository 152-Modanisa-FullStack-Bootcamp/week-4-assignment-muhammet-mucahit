      ...
      await provider.addInteraction({
        ...
        willRespondWith: {
          ...
          body: eachLike({
            ...
            description: like('Learn Vue 3 by in this full course. Vue.js is an open-source model–view–view model front ' +
              'end JavaScript framework for building user interfaces and single-page applications.'),
          })
        }
      })
